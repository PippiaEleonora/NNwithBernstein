...
%                     coeffP = coefficients(poly, precision(l,t), [], []); % TBI
                ...
                Pplus = intersectionHull('lcon',poly_curr.A,poly_curr.b,poly_curr.Aeq,poly_curr.beq,...
                    'lcon', -W{l,1}(t,:),bias{l,1}(t)-Iconfident(2));
                Pminus = intersectionHull('lcon',poly_curr.A,poly_curr.b,poly_curr.Aeq,poly_curr.beq,...
...
%                 Pminus = lcon2vert([poly_curr.A; halfspaceMinus.A],[poly_curr.b; halfspaceMinus.b]);
                ...
                P = lcon2vert([poly_curr.A; verticalspace.A], [poly_curr.b; verticalspace.b]); % TBI

                if  ~isempty(P) %P.lcon = {A,b,Aeq,beq}
...
%             end
            ...
            [P_new,Project] = degeneration('lcon',poly_curr);
